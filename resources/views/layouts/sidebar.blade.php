                  ...
                  <a href="index.html" class="menu-dropdown-item group"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('specialOrder.index') }}" class="menu-dropdown-item group"
                                        :class="window.location.href.includes('{{ route('specialOrder.index') }}') ?
                                            'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                        طلبات خاصة
                                    </a>
                                </li>
                    ...
                    <li>
                        <a href="{{ route('Coupon.index') }}"
                            @click="selected = (selected === 'Profile' ? '':'Profile')" class="menu-item group"
                            :class="window.location.href.includes('{{ route('Coupon.index') }}') ? 'menu-item-active' :
                                'menu-item-inactive'">
                    ...
                    <li>
                        <a href="{{ route('Vehicle.index') }}"
                            @click="selected = (selected === 'Profile' ? '':'Profile')" class="menu-item group"
                            :class="window.location.href.includes('{{ route('Vehicle.index') }}') ? 'menu-item-active' :
                                'menu-item-inactive'">
